...
/* Standard interface: HelloWorld, ver. 1.0,
 ...
 extern const MIDL_STUBLESS_PROXY_INFO HelloWorld_ProxyInfo;
    ...
    /* [string][in] */ const unsigned char *name)
{
    ...
    NdrClientCall3(
                  ( PMIDL_STUBLESS_PROXY_INFO  )&HelloWorld_ProxyInfo,
                  0,
                  0,
                  hBinding,
                  name);
...
static const MIDL_STUB_DESC HelloWorld_StubDesc = 
    ...
    MIDL_user_allocate,
    MIDL_user_free,
    &HelloWorld__MIDL_AutoBindHandle,
    0,
    0,
    0,
    0,
    ...
    0x2000001, /* MIDL flag */
    0, /* cs routines */
    (void *)& HelloWorld_ProxyInfo,   /* proxy/server info */
    0
    };
#ifdef __cplusplus
}
...
static const MIDL_STUBLESS_PROXY_INFO HelloWorld_ProxyInfo =
    {
    &HelloWorld_StubDesc,
    HelloWorld__MIDL_ProcFormatString.Format,
    HelloWorld_FormatStringOffsetTable,
